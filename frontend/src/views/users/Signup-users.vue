    ...
    <div class="card-groupomania">
        ...
        <b-form @submit.prevent="submitForm" class="form">
            <b-form-group label="Nom" label-for="name">
                <b-form-input id="name" placeholder="Entrer votre nom" type="text" autofocus v-model="$v.name.$model" :class="{ 'is-invalid' : $v.name.$error, 'is-valid' : !$v.name.$invalid }" ></b-form-input>
            ...
            <b-form-group label="Email" label-for="email">
                <b-form-input id="email" placeholder="Entrer votre email" type="email" v-model="$v.email.$model" :class="{ 'is-invalid' : $v.email.$error, 'is-valid' : !$v.email.$invalid }"></b-form-input>
